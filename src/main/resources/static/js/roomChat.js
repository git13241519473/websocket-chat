$(function () {
    ...
    function openSocket() {
        ...
        var socketUrl = "ws://localhost:8081/imserverroom/"+ $("#roomId").val() +"/" + $("#userId").val();
        ...
        socket.onmessage = function (msg) {
            ...
            if(message.type == "0"){ //系统消息
                ...
                if(userId == $("#userId").val()){
                    $("#showMsgs").append("<p style='color: fuchsia;'>"+ userId +" : "+ message.contentText +"</p>");
                }else{
                    $("#showMsgs").append("<p style='color: green;'>"+ userId +" : "+ message.contentText +"</p>");
                }
            }
        };
        //关闭事件
    ...
    function sendMessage(param) {
        if (typeof(WebSocket) == "undefined") {
            ...
            $("#contentText").val("");
            socket.send('{"roomId":"'+ param.roomId +'","contentText":"'+ param.contentText +'"}');
        }
    }
